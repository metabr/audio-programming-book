...
// Changed this file to provide the number of frames
/** open input soundfile (any format supported by libsndfile)
   ...
   frames:  number of sample frames in the file \n
   \n
   returns: soundfile handle or 0 if not successful
*/
SNDFILE *soundin_open(char* name, int *chans, float *sr, int *frames);
